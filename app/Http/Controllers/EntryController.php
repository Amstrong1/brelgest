...
class EntryController extends Controller
{
    public function index()
    {
        ...
        ->select('t_entreestock.DateEntree', 't_entreestock.LibProd', 't_entreestock.Qtte', 't_entreestock.PrixVenteUnit', 't_entreestock.Pri_AchatTotal', 't_entreestock.Observation', 't_produit.RefProd')
